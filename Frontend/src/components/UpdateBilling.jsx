        ...
        <div className="profile-wrapper-area py-3">
          <div className="card user-data-card">
            ...
            <div className="mb-3">
                        ...
                        <input className="form-control" name="patemail" value={editedBilling.patemail} readOnly />
                      </div>
                      <div className="mb-3">
                        <div className="title mb-2"><span>Patient Name</span></div>
                        <input className="form-control" name="patient_name" value={editedBilling.patient_name} readOnly />
                      </div>
                      <div className="mb-3">
                        <div className="title mb-2"><span>Amount</span></div>
                        <input className="form-control" name="amount" value={editedBilling.amount} onChange={handleInputChange} />
                        </div>
                      <div className="mb-3">
                        <div className="title mb-2"><span>Amount Paid</span></div>
                        <input className="form-control" name="amount_paid" value={editedBilling.amount_paid} onChange={handleInputChange} />
                       </div>
                      <div className="mb-3">
                        <div className="title mb-2"><span>Balance</span></div>
                        <input className="form-control" name="balance" value={editedBilling.balance} onChange={handleInputChange} />
                      </div>
