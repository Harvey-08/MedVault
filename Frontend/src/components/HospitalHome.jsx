            ...
            <div className="container">
                    ...
                    <div className="card-body d-flex align-items-center">
                      <div className="card-body"><img src={imgHis} className="img-fluid" style={{ width: 64, height: 64 }} />
                        <Link className="text-success" to="/view_prescription">
                          Patient's Treatment History </Link>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="row g-3">
                ...
                <div className="col-6 col-md-6">
                  <div className="card horizontal-product-card">
                    <div className="card-body d-flex align-items-center">
                      <div className="card-body"><img src={imgPfl} className="img-fluid" style={{ width: 64, height: 64 }} />
                    ...
                    <div className="card-body d-flex align-items-center">
                      <div className="card-body"><img src={imgLab} className="img-fluid" style={{ width: 64, height: 64 }} />
                        <Link className="text-success" to="/view_labtest">
                          View Patient's Lab Reports  </Link>
                      </div>
                    </div>
                  </div>
                </div>
